...
app.whenReady().then(async()=>{
  ...
  try{
    ...
    fs.mkdirSync(output,{recursive:true});await new Promise(r=>setTimeout(r,120));fs.writeFileSync(path.join(output,"sessions-desktop.png"),(await win.webContents.capturePage()).toPNG());
