const DATA_URL = "https://cdn.jsdelivr.net/gh/drydream/poe2drydream@main/public/tree-pre.json";
const SKILLS_URL = "https://cdn.jsdelivr.net/gh/drydream/poe2drydream@main/public/atlas-skills.webp";
const FRAMES_URL = "https://cdn.jsdelivr.net/gh/drydream/poe2drydream@main/public/atlas-frame.webp";
const TREE_JUMP_URL = "https://cdn.jsdelivr.net/gh/drydream/poe2drydream@main/public/tree-jump.json";
const CN_TRANSLATION_URL = "https://cdn.jsdelivr.net/gh/addohm/PathOfBuilding-PoE2@cn-item-paste-upstream/src/Data/ChineseTranslation.lua";
const MASTERY_EFFECT_ATLAS_JSON_URL = "https://cdn.jsdelivr.net/gh/grindinggear/poe2-skilltree-export@main/assets/mastery-effect-active.json";
const MASTERY_EFFECT_ATLAS_IMG_URL = "https://cdn.jsdelivr.net/gh/grindinggear/poe2-skilltree-export@main/assets/mastery-effect-active.webp";
const OFFICIAL_TREE_URL = "https://cdn.jsdelivr.net/gh/grindinggear/poe2-skilltree-export@main/data.json";
...
function classPortraitUrl(className) {
  ...
  return `https://cdn.jsdelivr.net/gh/drydream/poe2drydream@main/public/assets/background-${slug}.webp`;
}
